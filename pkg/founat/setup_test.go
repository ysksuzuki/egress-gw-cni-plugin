...
func setup() {
	...
	runIP("link", "add", "veth-egress", "type", "veth", "peer", "name", "veth-egress2")
	runIP("link", "set", "veth-egress", "netns", nsClient, "name", "eth0", "up")
	runIP("link", "set", "veth-egress2", "netns", nsRouter, "name", "eth0", "up")
	runIP("link", "add", "veth-egress", "type", "veth", "peer", "name", "veth-egress2")
	runIP("link", "set", "veth-egress", "netns", nsRouter, "name", "eth1", "up")
	runIP("link", "set", "veth-egress2", "netns", nsEgress, "name", "eth0", "up")
	runIP("link", "add", "veth-egress", "type", "veth", "peer", "name", "veth-egress2")
	runIP("link", "set", "veth-egress", "netns", nsEgress, "name", "eth1", "up")
	runIP("link", "set", "veth-egress2", "netns", nsTarget, "name", "eth0", "up")
